...
// (+) Сохранение состояния "свёрнуто\развёрнуто"
// (+) Проработка компонентов
// (+) Вид компонентов ^ v X
// ( ) Иконки кнопок   ^ v X
// (+) Коррекция размеров ST
// -------------------
// ( ) [X] видно только когда, на панели hover (MouseEnter)
// -------------------
// ( ) Почему при перемещении ST происходит ~
// ( ) При длинном списке и ЛКМ-е список прыгает
// ( ) 
// ( ) 
// ( ) 
// ( ) 
